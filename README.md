EcoCycleCloud is a system composed of intelligent recycling bin modules and a mobile application that connects to the bins via wireless networks to access user data.
 ...
 The mobile app provides the locations of multiple EcoCycleCloud smart bins installed across Hong Kong, allowing users to bookmark them. Marked bins display the capacity of each compartment to provide usability situations. The app also organizes and displays score records received from the bins, enabling users to track their recycling performance.
