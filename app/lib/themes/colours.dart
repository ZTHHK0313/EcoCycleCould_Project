import 'package:flutter/material.dart' show MaterialColor, MaterialAccentColor, Color;
...
const MaterialAccentColor ecoGreenAccent = MaterialAccentColor(_ecoGreenAccentPrimary, <int, Color>{
